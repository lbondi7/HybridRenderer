...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer)
{
    ...
    vkGetPhysicalDeviceProperties(v->PhysicalDevice, &properties);


    auto atom_size = properties.limits.nonCoherentAtomSize;
...
VkDescriptorSet ImGui_ImplVulkan_AddTextureD(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout) {
    VkResult err;
